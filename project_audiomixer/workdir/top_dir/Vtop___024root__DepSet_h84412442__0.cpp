...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(1U) = (((IData)(vlSelf->reset) 
                                       & (~ (IData)(vlSelf->__Vtrigrprev__TOP__reset))) 
                                      | ((IData)(vlSelf->top__DOT__clkdiv_inst__DOT__hz1) 
                                         & (~ (IData)(vlSelf->__Vtrigrprev__TOP__top__DOT__clkdiv_inst__DOT__hz1))));
    vlSelf->__VactTriggered.at(2U) = (((IData)(vlSelf->reset) 
                                       & (~ (IData)(vlSelf->__Vtrigrprev__TOP__reset))) 
                                      | ((IData)(vlSelf->top__DOT__clkdiv_inst2__DOT__hz1) 
                                         & (~ (IData)(vlSelf->__Vtrigrprev__TOP__top__DOT__clkdiv_inst2__DOT__hz1))));
    vlSelf->__VactTriggered.at(3U) = ((IData)(vlSelf->hz2m) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__hz2m)));
    ...
    vlSelf->__VactTriggered.at(7U) = ((IData)(vlSelf->top__DOT__sample_clk) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__top__DOT__sample_clk)));
